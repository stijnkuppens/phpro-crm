...
- [x] **ACCT-01**: Account detail page has all 7 tabs fully functional — overview, contacts, deals, activities, contracts, communication, revenue
...
- [x] **CONT-01**: Contact steering committee flag (is_steerco boolean) — visible in contact list and detail
- [x] **CONT-02**: Contact role tracking with all demo roles (Decision Maker, Influencer, Champion, Sponsor, Steerco Lid, Technisch, Financieel, Operationeel, Contact)
...
- [x] **DEAL-02**: Quick deal creation from bench consultant — opens pre-filled deal modal from bench page with consultant info
