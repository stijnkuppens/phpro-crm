...
type DataTableFilterProps =
    ...
    | {
    filterBar?: never;
    /** Auto-generated filters: current filter state keyed by column accessorKey */ filters: Record<string, string | undefined>;
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start gap-2 p-3">
                                        ...
                                        {actions.length > 0 && (
                                            <MobileRowActions actions={actions} row={row}/>
                                        )}
                                    </div>
                                </div>
                            );
                    ...
                    <Table>
                        ...
                        <TableBody
                            ...
                            {loading ? (
                                ...
                                <TableRow>
                                    <TableCell colSpan={allColumns.length + (rowActions ? 1 : 0)}
